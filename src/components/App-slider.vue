...
//    import from 'bootstrap';
    ...
    export default {
        data: function () {
            return {
                images: [
                    'http://peexoo.ai/images/DSC.jpg',
                    'http://peexoo.ai/images/8x10-3.jpg',
                    'http://peexoo.ai/images/DSC_6377.jpg',
                    'http://peexoo.ai/images/DSC_1612.jpg'
                ]
            }
        },
        mounted: function () {
            ...
            $canvas.attr('height', ((jQuery(window).height()) > 700) ? (jQuery(window).height() - 88) : jQuery(window).height());
            $canvas.kenburned({
                images: this.images,
