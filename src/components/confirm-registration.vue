                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="alert-contain">
                            <h5>Congratulations, you just got in</h5>

                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img class="def-img" src="../assets/images/afroshots.png" alt="image">
                                    </div>
                                    <div class="col-md-4">
                                        <img class="def-img" src="../assets/images/afroshots.png" alt="image">
                                    </div>
                                ...
                                <p class="text-center mt-4 mb-4">
                                    <router-link class="peexo-faded-text" to="/photos/explore">
                                        Explore more Photos
                                    </router-link>
                                </p>
...
<script>
    const base_url = 'http://e3d115ec.ngrok.io';
