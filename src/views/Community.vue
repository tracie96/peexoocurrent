<template>
    <div>
        <PHeader />
        <CommunityHeader />
        <div class="mt-10 row ml-mr desktop" id="">
            <!-- Grid column -->
        ...
        <div id="mobile-gallery" class="">
            <div class="col-6">
                <div class="mg-b pics all 2 animation" style="">
                    <img class="img-fluid" style="height:271px;width:100%" src="../assets/images/left.png"
                        alt="Card image cap">
                </div>
            </div>
            <div class="col-6">
                <div class="mg-b pics all 1 animation" style="">
                    <img class="img-fluid" style="height:142px;width:100%" src="../assets/images/middle-top.png"
                        alt="Card image cap">
                </div>
                <div class="mg-b pics all 1 animation" style="">
        ...
        <section class="xs-section-padding">
            <div class="container">
                ...
                <div id="carouselIndicators" class="desktop carousel slide" data-ride="carousel">
...
Our fully automated AI, ultra-innovative tools are available round the clock to solve the problem of long post-production time, to creating high quality images in seconds. Peexoo gives your photography the boost it deserves.                                    </p>
                ...
                <div id="accordion" class="mg-top mobile-only">
                    <div class="card">
                        <img src="../assets/images/grid-image.png" alt="">
                        <div class="box-shd">
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0">
                                    <a href="#" class="expand-text" data-toggle="collapse" data-target="#collapseOne"
                                        ...
                                        Meet Great Minds <i class="float-right fa fa-angle-down rotate-icon"></i>
                                    </a>
                                </h5>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    ...
                                    facere ab corporis rem delectus, quam illum eius consectetur incidunt!
                                    Fuga, dicta nam vitae eos inventore nisi quaerat. Mollitia, excepturi.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="box-shd">
                            <div class="card-header" id="headingTwo">
                                <h5 class="mb-0">
                                    <a href="#" class=" collapsed" data-toggle="collapse" data-target="#collapseTwo"
                                        ...
                                        Learn <i class="float-right fa fa-angle-down rotate-icon"></i>
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                data-parent="#accordion">
                                <div class="card-body">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eum quidem officia
                                    perferendis provident quae adipisci exercitationem quis asperiores a
                                    tque animi similique est, dicta iure error, dolorem accusantium in. Qui, soluta!
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header" id="headingThree">
                                <h5 class="mb-0">
                                    <a href="#" class="collapsed" data-toggle="collapse" data-target="#collapseThree"
                                        ...
                                        Showcase <i class="float-right fa fa-angle-down rotate-icon"></i>
                                    </a>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="headingFour">
                                <h5 class="mb-0">
                                    <a href="#" class="collapsed" data-toggle="collapse" data-target="#collapseFour"
                                        ...
                                        Get Support <i class="float-right fa fa-angle-down rotate-icon"></i>
                                    </a>
                                </h5>
                            </div>
                ...
                <div class="mt-5 agency-section-title text-center section-title-style2">
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2 desktop">
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                                <img class="" src="../assets/images/verified.svg" alt="">
...
<style scoped>
    ...
    .box-shd {
        box-shadow: 0 3px 12px 0 rgba(134, 134, 134, 0.5) !important;
    }
