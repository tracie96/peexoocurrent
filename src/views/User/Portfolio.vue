<template>
    <div>
            <uploadporfolio :show="showUploadPortfolio" @close="showUploadPortfolio = false"
            v-on:submit-modal="shownextModal"></uploadporfolio>
        <uploadporfolioimages :show="uploadPortfolioModal" @close="uploadPortfolioModal = false"
            v-on:go-back="showPreviousModal"></uploadporfolioimages>
        <sidebar></sidebar>
        <topbar></topbar>
        ...
        <div class="pagecontent">
            <div class="top-page-content">
                ...
                <div class="text-center mt-100 mb-100">
                    ...
                    <button @click="addPortfolio" style="border-radius: 5px !important;color:#fff !important"
        ...
        <div class="pagecontent">
            ...
            <div class="row mt-3">
                <div class="col-md-3" v-for="(pot, index) in portfolios" :key="index">
                    <portfoliocard :id="pot.id" :name="pot.name" :videos="pot.videos" :images="pot.images"
                        :src="pot.src" />
                </div>
                <div class="col-md-3">
                    <div class="row">
