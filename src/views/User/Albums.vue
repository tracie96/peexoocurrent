            ...
            <div class="top-page-content">
                ...
                <div class="text-center mt-100 mb-100">
                    ...
                    <router-link to="/albums/create" class="">
                        <button style="border-radius: 5px !important;color:#fff !important" class="mr-4 btn btn-peexoo">
                            <i class="fa fa-plus"></i> Create Album
                        </button>
                    </router-link>

                    <button style="border-radius: 5px !important;color:#fff !important" class="btn btn-peexoo">
             ...
             <div class="top-page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="">
                            ...
                            <router-link to="/albums/create" class="">
                                <button style="border-radius: 5px !important;color:#fff !important;margin-right:10px !important"
                                    class=" btn btn-peexoo">
                                    <i class="fa fa-plus"></i> Create Album
                                </button>
                            </router-link>
                            <button @click="showuploadImages" style="border-radius: 5px !important;color:#fff !important" class="btn btn-peexoo">
                                <i class="fa fa-upload"></i> Upload Images
                            </button>
                    ...
                    <nav>
                        <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-albums-tab" data-toggle="tab" href="#nav-albums"
                                role="tab" aria-controls="nav-albums" aria-selected="true">My Albums</a>
                            <a class="nav-item nav-link" id="nav-shared-tab" data-toggle="tab" href="#nav-shared"
                                role="tab" aria-controls="nav-shared" aria-selected="false">Shared Albums </a>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-albums" role="tabpanel"
