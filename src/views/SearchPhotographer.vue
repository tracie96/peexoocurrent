        ...
        <div class="container">
            <div class="row mt-15">
                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    <p class="p-title-category">
                      ...
                      <div class="row mb-3">
                        <div class="col-6">
                            From
                              <input placeholder="0" v-model="minprice" type="number" class="form-control">
                        </div>
                       <div class="col-6">
                            To
                              <input placeholder="0" v-model="maxprice" type="number" class="form-control">
                        </div>
                    ...
                    <p class="text-center mb-5">
                        <button id="btn-p" class="btn btn-rounded btn-peexoo text-white">ENTER
                        </button>
                    </p>
                ...
                <div id="searchbar" class="searchbar">
                    ...
                    <a href="javascript:void(0)" class="closebtn" @click="closeSearchBar">&times;</a>
                    <div>
                        <vue-simple-suggest class="myinpt"
                            v-model="chosen"
                ...
                <div class="col-md-8 col-12">
                    ...
                    <div class="row n-row">
                        <div class="col-md-6 cad" v-for="(card, key) in Photographers" :key="key">
