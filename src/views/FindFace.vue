<template>
    <div>
        ...
        <div class="row" v-if="albums.length === 0">
            ...
            <div class="col-md-6 ">
                <div class="selfie-box mr-10 mt-12" v-if="!processing && !error" @click="openFileInput">
                    <div class="text-icon">
                        <input @change="previewImage" style="display:none" name="file" type='file' id="imgInp" />
                ...
                <div class="selfie-box mr-10 mt-12" v-if="processing">
                    <div class="processing">
                        <p><i class="fa fa-3x fa-spinner fa-spin peexo-highlight-text"></i></p>
                        <span class="peexo-body-text">Wait while we search our bank of images for your
                            pictures...</span>
                    </div>
                ...
                <div class="selfie-box mr-10 mt-12" v-if="error">
                    <div class="processing">
                        ...
                        <span class="peexo-body-text">We couldn’t find any image of you in our database</span>
                ...
                <p class="mt-4 mb-5 mr-10 text-center peexo-body-text">
                    Find exclusive pictures of yourself in different events that you attended. Each event
                    cost 500 for all images in the event
                </p>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-3" v-for="(face, index) in albums" :key="index">
                    <mdb-card>
                        <mdb-view>
                            <div>
                                <mdb-card-image class="face-img" :src="face.imgurl" alt="Card image cap"></mdb-card-image>
                            </div>
                            <div class="p-3">
                                ...
                                <div class="clearfix">
                                    <div class="float-right peexo-faded-text card-inner-text"  :face="face" @click="onDivCick(face)">
                                       {{!hasPaid ? 'ADD TO COLLECTION': 'DOWNLOAD' }}
                                    </div>
                                    <!-- <div class="float-right peexo-faded-text card-inner-text" :face="face" @click="addToCollection">
                                        {{!hasPaid ? 'ADD TO COLLECTION': 'DOWNLOAD' }}
                                    </div> -->
                                    <div class="float-left card-inner-text"> {{face.images}} images </div>
                                </div>
                            </div>
                        </mdb-view>
...
<script>
    ...
    import { mdbCard, mdbCardImage, mdbCardBody, mdbCardTitle, mdbCardText, mdbView } from 'mdbvue';

    export default {
        name: 'find-my-face',
        props:['face'],
        components: {
            downloadmodal,addcollectionmodal,paymentsuccess,
            PHeader, Footer, Menu,
