    ...
    <div>
        ...
        <transition name="fade">
            <div class="container-fluid d-div w-bg" v-if="chosenimages.length >= 1">
                <div class="download-section">
                    <span v-if="chosenimages.length == 1" @click="shareImage" class="icon-span">
        ...
        <div class="container ">
            <div class="row" :class="{'face-div': chosenimages.length == 0}">
                <div class="checkbox">
                    <label>
                        <input @click='checkAll()' v-model='isCheckAll' type="checkbox" value="">
                        <span class="cr"><i class="cr-icon"></i></span>
                        Select All
                    </label>
                </div>
                <section id="gal-sec">
                    <div :href="img.url" class="di" v-for="(img, index) in imageList" :key="index" :data-index="index"
                        :style="{flexGrow:img.width*200/img.height,width:img.width*200/img.height + 'px'}">
                        <i :style="{paddingBottom:img.height/img.width*100+'%'}"></i>
                        <div class="checkbox change-checkbox-position">
                            <label>
                                <input v-bind:value='img' v-model='chosenimages' @change='updateCheckall()'
                                    type="checkbox" value="">
                                <span class="cr"><i class="cr-icon"></i></span>
        ...
        data: function () {
            return {
                ...
                imageList: [
                    {
                        id: 1,
                        url: 'https://cdn.pixabay.com/photo/2017/08/03/21/48/drinks-2578446__340.jpg',
                        width: 509,
                        height: 340
                    },
                    {
                        id: 2,
                        url: 'https://cdn.pixabay.com/photo/2015/09/02/12/39/child-918582__340.jpg',
                        width: 226,
                        height: 340
                    },
                    {
                        id: 3,
                        url: 'https://cdn.pixabay.com/photo/2015/07/02/10/06/sparklers-828570__340.jpg',
                        width: 2000,
                        height: 1333
                    },
                    {
                        id: 4,
                        url: 'https://cdn.pixabay.com/photo/2019/03/26/02/51/woman-4081760__340.jpg',
                        width: 510,
                        height: 340
                    },
                    {
                    ...
                    {
                        id: 9,
                        url: 'https://cdn.pixabay.com/photo/2019/04/08/04/22/glasses-4111357__340.jpg',
                        width: 666,
                        height: 1000
                    },
                    {
                        id: 10,
                        url: 'https://cdn.pixabay.com/photo/2016/11/21/16/55/adult-1846436__340.jpg',
                        width: 775,
                        height: 1170
                    },
